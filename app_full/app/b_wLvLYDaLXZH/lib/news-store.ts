// TODO: REMOVE — This file has been merged into app_full/lib/news-store.ts and is no longer needed.
...
export function validateForPublish(a: EditorArticle): ValidationError[] {
  ...
  if (!a.imagePreview) {
    errs.push({ field: "image", message: "A featured image is required to publish." })
  }
