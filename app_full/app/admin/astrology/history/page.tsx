...
import { adminListCharts, type ChartSummary } from "@/lib/astrology-api"
import { History, Sparkles, ChevronRight, CalendarDays, MapPin, Search } from "lucide-react"
        ...
        {isLoading ? (
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody>
                {charts.map((chart) => (
                  <tr key={chart.id} className="border-b border-border/50 hover:bg-secondary/20 transition">
                    ...
                    <td className="px-4 py-3">
                      <p className="text-xs text-foreground flex items-center gap-1">
                        ...
                        {new Date(chart.dob).toLocaleDateString("en-IN", { day: "2-digit", month: "short", year: "numeric" })}
                        {" · "}{chart.time_of_birth}
                      </p>
